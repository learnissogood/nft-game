        ...
        <Content className="h-[100vh] bg-gradient-to-b from-black to-cyan-900">
          <nav className="p-6">
            <div className="grid justify-items-stretch p-6">
              <div className="flex items-center font-bold text-grey text-base h-10 px-8 pt-3 rounded-full w-auto justify-self-end bg-gradient-to-r from-cyan-500 to-fuchsia-500">
                <p>
                  {" "}
